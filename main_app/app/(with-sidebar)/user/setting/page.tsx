...
async function getConnectedApplications(userId: string) {
  // Get all active access tokens (which means apps currently have access)
...
async function revokeAccess(accessTokenId: string) {
  "use server";
...
export default async function UserSettings() {
  ...
  const { activeTokens } = await getConnectedApplications(session.user.id);
    ...
    <div className="container mx-auto max-w-6xl p-6 space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Manage applications that have access to your resume data
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-xl font-semibold">Applications with Access</h2>
                            ...
                            <DialogHeader>
                              ...
                              <DialogDescription className="space-y-2">
                                ...
                                <p className="text-sm">
                                  ...
                                  application will need to request authorization
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground max-w-md mx-auto">
                    You haven't authorized any applications to access your
                    resume data yet. When you do, they'll appear here and you
                    can manage their permissions.
                  </p>
                </div>
                <div className="pt-2">
                  <p className="text-xs text-muted-foreground">
                    Applications will request access through OAuth when you use
                    them
                  </p>
                </div>
              </div>
