...
const config: Config = {
  ...
  projectName: "centralresume", // Usually your repo name.
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/anisharaz/centralresume/apps/docs/",
        },
        blog: {
          ...
          // Please change this to your repo.
          // Remove this to remove the "edit this page" links.
          editUrl: "https://github.com/facebook/docusaurus/apps/docs/",
